...
I've only tried testing this with the `cowplot` package, so I cannot say for sure that the functions won't break when applied with other themes.[@wilkeCowplotStreamlinedPlot2019]
