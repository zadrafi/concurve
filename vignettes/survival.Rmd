...
We'll use the `carData` package for this. [Fox & Weisberg, 2018](https://www.john-fox.ca/Companion/appendices/Appendix-Cox-Regression.pdf) describe the dataset elegantly in their paper,
