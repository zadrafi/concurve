...
You can also directly download a tarball or zip of the most recent package version using the [following link](https://github.com/zadrafi/concurve/releases). 
...
- **`curve_snowflake()`** - Construct consonance distributions directly from Snowflake database query results
- **`curve_snowflake_batch()`** - Batch processing for multiple Snowflake analyses
- **`export_for_powerbi()`** - Export consonance data in Power BI-ready format
...
- **`curve_summary()`** - Generate summary statistics for consonance objects
