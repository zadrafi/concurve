...
# Package imports (updated for v3.0 - removed pbmcapply)
Imports <- c(
  "methods", "bcaboot", "boot", "lme4", "dplyr", "flextable", "ggplot2",
  "knitr", "metafor", "officer", "parallel", "ProfileLikelihood",
...
kable(Imports,
  booktabs = T, format = "html", col.names = colnames(Imports), table.attr = "class=\"striped\"",
...
```{r echo=FALSE, eval=has_kable}
# Package suggests (updated for v3.0 - added DBI, odbc for Snowflake)
suggests <- c(
  "DBI", "odbc", "MASS", "covr", "roxygen2", "spelling", "testthat", "rmarkdown", "Lock5Data",
...
kable(suggests_df,
  booktabs = T, format = "html", col.names = colnames(suggests_df), table.attr = "class=\"striped\"",
