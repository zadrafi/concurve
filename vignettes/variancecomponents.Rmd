...
```{r}
library(concurve)
object1 <- curve_lmer(object = fm1, parm = "Days", method = "profile", steps = 100)

sample1 <- curve_lmer(object = fm1, parm = ".sig01", method = "profile", steps = 100)
...
sample2 <- curve_lmer(object = fm1M, parm = ".sig01", method = "profile", steps = 100)
