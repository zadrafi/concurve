---
title: "Using Stata"
description: "A simple guide on how to produce consonance functions in Stata."
output: rmarkdown::html_vignette
opengraph:
  image: 
    src: "https://upload.wikimedia.org/wikipedia/commons/7/79/Stata_logo_med_blue.png"
  twitter:
    card: summary
    creator: "@dailyzad"
vignette: >
...
![fractional polynomial model](mfp.svg){width=150% height=150%}    

Now, was there any real purpose to fitting a multivariable fractional polynomial? No, but I am a gigantic fan of it for variable selection and transformations and wanted to do it anyway, especially if it can help people get more exposure to it. Moving on...
...
```{stata, cleanlog=FALSE, results="hide"}
clear
sysuse auto2
postfile topost level pvalue svalue lointerval upinterval using my_new_data, replace
...
```
![Consonance](confidence.svg){width=150% height=150%}  

Pretty neat, eh? And below is what our surprisal function looks like, which is simply the $-\log_{2}$(_p_) transformation of the observed P-value. For a more comprehensive discussion on surprisals, [see this page]() and check out some of the references at the bottom.
...
![Surprisal Function](surprisal.svg){width=150% height=150%}  
