...
I'll now enable parallelization by setting the `mc.cores` option to detect the max number of cores available using `detectCores()`. The `mc.cores` option is the argument that almost all the curve functions in the `concurve` package use for parallel computing.
