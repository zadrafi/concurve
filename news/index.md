...
- [`curve_gen()`](https://stat.lesslikely.com/concurve/reference/curve_gen.md)
  now includes options to adjust CIs and P-values for multiple
  comparisons.
- [`curve_gen()`](https://stat.lesslikely.com/concurve/reference/curve_gen.md)
  can now accept inputs from the `rms` package’s `ols()` function.
...
- An error in
  [`curve_rev()`](https://stat.lesslikely.com/concurve/reference/curve_rev.md)
  was fixed where for the default measure, the computations were
  calculated as if measure was set to ratio.
  - Thank you to [Aaron Caldwell](https://twitter.com/ExPhysStudent) for
    his generous help in fixing this bug.
- [`curve_rev()`](https://stat.lesslikely.com/concurve/reference/curve_rev.md)
  can now take summary statistics such as the point estimate and it’s
  standard error to back calculate the function.
...
- [`curve_boot()`](https://stat.lesslikely.com/concurve/reference/curve_boot.md)
  now takes an option allowing users to specify the number of cores to
  be used.
- Graphing functions such as
  [`ggcurve()`](https://stat.lesslikely.com/concurve/reference/ggcurve.md)
  and
  [`plot_compare()`](https://stat.lesslikely.com/concurve/reference/plot_compare.md)
  now have the options to customize the second y-axis and also change
  the color of the outline of the functions.
  - Thus, the argument `yaxis` has been replaced by `yaxis1` and
    `yaxis2`.
  - For
    [`plot_compare()`](https://stat.lesslikely.com/concurve/reference/plot_compare.md)
    color has been replaced by `color1` and `color2`
...
- [`curve_meta()`](https://stat.lesslikely.com/concurve/reference/curve_meta.md)
  can now handle complex data structures from `metafor` with clustered
  data.
- [`curve_gen()`](https://stat.lesslikely.com/concurve/reference/curve_gen.md)
...
- [`expand_scale()`](https://ggplot2.tidyverse.org/reference/expansion.html)
  ...
  within the inner workings of
  [`ggcurve()`](https://stat.lesslikely.com/concurve/reference/ggcurve.md)
  and
  [`plot_compare()`](https://stat.lesslikely.com/concurve/reference/plot_compare.md)
  due to the former function
  ([`expand_scale()`](https://ggplot2.tidyverse.org/reference/expansion.html))
  being deprecated.
...
- [`ggconcurve()`](https://stat.lesslikely.com/concurve/reference/defunct.md)
  is now
  [`ggcurve()`](https://stat.lesslikely.com/concurve/reference/ggcurve.md).
- [`ggcurve()`](https://stat.lesslikely.com/concurve/reference/ggcurve.md)
  plots confidence (consonance) distributions, densities, likelihood,
  and deviance functions.
...
- [`plot_compare()`](https://stat.lesslikely.com/concurve/reference/plot_compare.md)allows
  two separate functions to be plotted and compared simultaneously.
- [`curve_table()`](https://stat.lesslikely.com/concurve/reference/curve_table.md)
  produces publication-ready tables of relevant statistics.
- [`curve_boot()`](https://stat.lesslikely.com/concurve/reference/curve_boot.md)
  uses bootstrapping to approximate the consonance functions via the
...
- [`curve_lik()`](https://stat.lesslikely.com/concurve/reference/curve_lik.md)
  produces likelihood functions by transforming the objects from the
...
- [`ggconcurve()`](https://stat.lesslikely.com/concurve/reference/defunct.md)
  now plots both the P-values and CI level using both y-axes when the
  type = “consonance”. Previously, this was only possible via
  [`plot_concurve()`](https://stat.lesslikely.com/concurve/reference/defunct.md)
...
- [`plot_concurve()`](https://stat.lesslikely.com/concurve/reference/defunct.md)
  now has “measure” as an item which allows for ratio measures to be
  logarithmically scaled on the x axis. There are two options,
  “default”, which is set as the default option and is for mean
  differences, and “ratio”, which will result in the axis being
  logarithmically scaled.
- [`plot_concurve()`](https://stat.lesslikely.com/concurve/reference/defunct.md)
  also now has a “fill” option which will allow users to choose the
  color of the plot.
...
- The
  [`plotpint()`](https://stat.lesslikely.com/concurve/reference/defunct.md)
  function which plotted consonance functions has been repackaged into
  [`ggconcurve()`](https://stat.lesslikely.com/concurve/reference/defunct.md).
- The
  [`plotsint()`](https://stat.lesslikely.com/concurve/reference/defunct.md)
  function which plotted surprisal functions has been repackaged into
  [`ggconcurve()`](https://stat.lesslikely.com/concurve/reference/defunct.md).
...
- Can produce consonance and surprisal functions for correlations via
  the
  [`corrintervals()`](https://stat.lesslikely.com/concurve/reference/defunct.md)
  function.
- Now able to construct consonance and surprisal functions from the
  point estiate, and confidence limits via the
  [`rev_eng()`](https://stat.lesslikely.com/concurve/reference/defunct.md)
  function.
- Graphs produced via the
  [`plotpint()`](https://stat.lesslikely.com/concurve/reference/defunct.md)
  or
  [`plotsint()`](https://stat.lesslikely.com/concurve/reference/defunct.md)
  function now able to take custom titles, subtitles, x-axis titles, and
  captions.
