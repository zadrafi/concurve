...
<span style="color:#d46c5b">[**estimation**](https://github.com/Zadchow/estimation)</span>
package in R.
...
![](man/figures/README-unnamed-chunk-4-1.png)<!-- -->
    ...
    #> t = -1.0435, df = 27.779, p-value = 0.3057
    #> alternative hypothesis: true difference in means is not equal to 0
    #> 95 percent confidence interval:
    #>  -1.123797  0.365410
    #> sample estimates:
    #>   mean of x   mean of y 
    #> -0.03539677  0.34379657
...
> <span style="color:#d46c5b">**install\_github(“zadchow/estimation”)**</span>
...
The graph above provides us with compatibility levels and the maximum
...
#> 
#> Call:
#> lm(formula = GroupA2 ~ GroupB2, data = RandomData2)
#> 
#> Residuals:
#>      Min       1Q   Median       3Q      Max 
#> -3.01104 -0.71038 -0.02482  0.65133  2.89052 
#> 
#> Coefficients:
#>             Estimate Std. Error t value Pr(>|t|)
#> (Intercept) -0.02609    0.04427  -0.589    0.556
#> GroupB2     -0.03305    0.04487  -0.737    0.462
#> 
#> Residual standard error: 0.9894 on 498 degrees of freedom
#> Multiple R-squared:  0.001088,   Adjusted R-squared:  -0.0009174 
#> F-statistic: 0.5427 on 1 and 498 DF,  p-value: 0.4617
confint(model)
#>                  2.5 %     97.5 %
#> (Intercept) -0.1130743 0.06089371
#> GroupB2     -0.1212011 0.05509959
```
...
![](man/figures/README-unnamed-chunk-9-1.png)<!-- --> Here’s our P-value
function.
...
![](man/figures/README-unnamed-chunk-10-1.png)<!-- --> Now our S-value
function.
