...
- [**Aaron Caldwell**](https://twitter.com/ExPhysStudent). Author. [
  ](https://orcid.org/0000-0002-4541-6283)

## Citation

Source:
[`inst/CITATION`](https://github.com/zadrafi/concurve/blob/HEAD/inst/CITATION)

Rafi Z, Vigotsky A (????). *concurve: Computes and Plots Compatibility
...
3.0, <https://CRAN.R-project.org/package=concurve>.
