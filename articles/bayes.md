...
#> Estimates:
#>                 mean   sd   10%   50%   90%
#> (Intercept)   77.5    2.0 74.9  77.5  80.1 
#> mom_hs        11.9    2.3  8.9  11.9  14.8 
...
#> MCMC diagnostics
#>               mcse Rhat n_eff
#> (Intercept)   0.1  1.0   961 
#> mom_hs        0.1  1.0   986 
#> sigma         0.0  1.0  1834 
#> log-fit_ratio 0.0  1.0  1298 
#> R2            0.0  1.0   972 
#> mean_PPD      0.0  1.0  3707 
#> log-posterior 0.0  1.0  1428 
#> 
...
#>   Visualization_. R package version 1.4.0, <https://scales.r-lib.org>.
#> 
#> A BibTeX entry for LaTeX users is
#> 
#>   @Manual{,
