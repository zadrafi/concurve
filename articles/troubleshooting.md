...
the correct argument. If you used a function like
[`curve_gen()`](https://stat.lesslikely.com/concurve/reference/curve_gen.md)
to generate intervals and saved it to an object called ‘object’, you
need to provide
[`ggcurve()`](https://stat.lesslikely.com/concurve/reference/ggcurve.md)
...
## Session info
    ...
    #> [17] htmlwidgets_1.6.4  tibble_3.3.1       desc_1.4.3         bslib_0.12.0      
    ...
    #> [41] colorspace_2.1-3   purrr_1.2.2        rmarkdown_2.31     tools_4.6.1       
