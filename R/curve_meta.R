...
#'
#' @param x Object where the meta-analysis parameters are stored, typically a list produced by 'metafor'
...
#' This is typically a setting used for binary outcomes such as risk ratios, hazard ratios, and odds ratios.
...
#' @param table Indicates whether or not a table output with some relevant statistics
#' should be generated. The default is TRUE and generates a table which is included in the
#' list object.
#'
#' @examples
#'
