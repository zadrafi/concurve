...
curve_lik <- function(formula, data, profile.theta, lo.theta = NULL, hi.theta = NULL,
  ...
  return(data.frame(theta = theta, log.norm.lik = log.norm.lik, profile.lik = profile.lik, profile.lik.norm = profile.lik.norm))
}
