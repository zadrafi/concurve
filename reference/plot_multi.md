...
Curve names (passed as named arguments) are automatically used as legend
labels. For example,
`plot_multi("Study A" = curve1, "Study B" = curve2)` will use "Study A"
and "Study B" as labels in the legend.
