...
- **[Zad Rafi](https://twitter.com/dailyzad)**. Author, maintainer.
  [](https://orcid.org/0000-0003-1545-8199)

- **[Andrew D.
  Vigotsky](https://www.researchgate.net/profile/Andrew_Vigotsky)**.
  Author. [](https://orcid.org/0000-0003-3166-0688)

- **[Aaron Caldwell](https://twitter.com/ExPhysStudent)**. Contributor.
  [](https://orcid.org/0000-0002-4541-6283)

## Citation

Source:
[`inst/CITATION`](https://github.com/zadrafi/concurve/blob/master/inst/CITATION)

Rafi Z, Vigotsky A (2026). *concurve: Computes and Plots Compatibility
(Confidence) Intervals, P-Values, S-Values, & Likelihood Intervals to
Form Consonance, Surprisal, & Likelihood Functions*. R package version
3.0.0, <https://CRAN.R-project.org/package=concurve>.
...
Compatibility and Surprise.” *BMC Medical Research Methodology*, **20**,
244. ISSN 1471-2288.
